...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9 
    */
    HAL_GPIO_DeInit(Angle_Rotor_GPIO_Port, Angle_Rotor_Pin);

    HAL_GPIO_DeInit(GPIOA, CURRENT_Ia_Pin|CURRENT_Ib_Pin);

    HAL_GPIO_DeInit(CURRENT_Ic_GPIO_Port, CURRENT_Ic_Pin);
